...
with st.form("user_input_form"):
    ...
    education = slider_container.slider("Drag bar to the right if you completed this education", min_value=education_options[education_selection][0], max_value=education_options[education_selection][1], value=education_options[education_selection][0])
